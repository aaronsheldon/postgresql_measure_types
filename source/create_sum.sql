...
CREATE AGGREGATE sum(numeric_numeric[])
(
	sfunc = array_cat,
...
CREATE AGGREGATE sum(numeric_interval[])
(
	sfunc = array_cat,
...
CREATE AGGREGATE sum(varchar_numeric[])
(
	sfunc = array_cat,
...
CREATE AGGREGATE sum(varchar_interval[])
(
	sfunc = array_cat,
...
CREATE AGGREGATE sum(timestamp_numeric[])
(
	sfunc = array_cat,
...
CREATE AGGREGATE sum(timestamp_interval[])
(
	sfunc = array_cat,
...
CREATE AGGREGATE sum(interval_numeric[])
(
	sfunc = array_cat,
...
CREATE AGGREGATE sum(interval_interval[])
(
	sfunc = array_cat,
